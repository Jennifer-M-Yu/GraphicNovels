...
label start:
    ...
    s "Well we have a lot of options for lunch, what are you in the mood for?"
    menu:
        "Something with four legs, like a deer. Maybe watching %(stranger_name)s hunt will reveal something.":
            ...
            $ hunter = True
        "Something that cannot eat you. Berries or plants seem like a safe option, maybe you can even find something useful.":
